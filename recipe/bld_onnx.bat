...
set "CMAKE_ARGS=%CMAKE_ARGS% -DPYTHON_EXECUTABLE:PATH=%PYTHON%"
set "CMAKE_ARGS=%CMAKE_ARGS% -DPYTHON_LIBRARIES:PATH=%LIBRARY_LIB%"
set "CMAKE_ARGS=%CMAKE_ARGS% -DPYTHON_INCLUDE_DIRS:PATH=%LIBRARY_INC%"
